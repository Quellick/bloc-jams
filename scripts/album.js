...
var togglePlayFromPlayerBar = function(){
  ...
  if(currentSoundFile.isPaused() === true){
    ...
    $(".song-item-number").eq(currentlyPlayingSongNumber-1).html(pauseButtonTemplate);
    ...
    $(".song-item-number").eq(currentlyPlayingSongNumber-1).html(playButtonTemplate);
...
var updatePlayerBarSong = function() {
 ...
 $(document).ready(function() {
     $togglePlayPause.click(togglePlayFromPlayerBar)
